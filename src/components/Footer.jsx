...
import hanoi from '../assets/img/PlaceImg/Hanoi/pexels-quý-nguyễn-17177476.jpg';
            ...
            <div className="px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3">
                ...
                <div className="pt-12 mt-12 border-t border-gray-800">
                    <p className="mt-4 sm:mt-0">
                        &copy; {new Date().getFullYear()} Vn_Nor Travel.
                    </p>

                    <p className="mt-8 text-xs sm:text-base text-white">

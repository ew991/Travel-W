...
import promo from '../assets/img/PlaceImg/HaGiang/pho-cao-2511-1648718523-6530-1657019232.jpg';
            ...
            <div className="relative section-center lg:h-3/4 lg:items-center lg:flex">
                <div className="max-w-xl text-center sm:text-left">
                    ...
                    <div className="grid gap-y-4 sm:grid sm:grid-cols-2 sm:gap-x-8  text-center">
                        <a
                            className="btn  text-white   bg-green-500  hover:bg-[#8AAAE5] active:bg-green-600   "
                            href="#tips"
                        >
                            Travel tips
                        </a>
                        ...
                        {/* <a
                            className="btn   text-green-500   bg-white  hover:text-[#8AAAE5] active:text-green-600 "
                            href="#readmores"
                        >
                            Learn More
                        </a> */}

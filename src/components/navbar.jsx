        ...
        <>
            <nav
                className={`text-center z-50 w-full absolute ${stickyNavbar
                    ? 'font-expletus animate-fade-in-down sticky top-0 bg-[#8AAAE5] shadow-sm'
                    : ''
                    }`}
            >
                <div
                ...
                >
                    ...
                    >
                        <img src={Logo} className="w-[80px] h-[80px] rounded-full" alt="company logo" />
                    ...
                    <div className="lg:hidden">
                        ...
                        {isMenuOpen && (
                            <div className="animate-fade-in-down absolute top-0 left-0 w-full text-black bg-[#8AAAE5] text-left p-5  border rounded shadow-sm">
